export default {
  ...
  proj4CrsName: 'Custom CRS name (proj4)',
  proj4CrsNameHint: 'Enter the name registered via proj4.defs(), e.g. YAM94. Leave WKID blank to use this field.',
  invalidProj4NameTips: 'No proj4 definition is registered for this name.'
}
